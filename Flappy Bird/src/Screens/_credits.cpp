...
namespace Game {
	namespace Credits
	{
		...
		void showCredits()
		{
			...
			DrawText("Héctor Iván Pereira", Game::HALF_SCREENWIDTH - (MeasureText("Héctor Iván Pereira", FONT_SIZE) / DIVIDER_MEASURE_TEXT), Game::SCREENHEIGHT / LINE_DIVIDER + FONT_SIZE * 7, FONT_SIZE, DARKGRAY);
